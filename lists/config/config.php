...
$database_name = 'vividwa';

// what user has access to this database
$database_user = 'vividwa';

// and what is the password to login to control the database
$database_password = 'vividwa123';
...
define("PHPMAILERHOST","smtpout.asia.secureserver.net");

# if you want to use smtp authentication when sending the email uncomment the following
# two lines and set the username and password to be the correct ones
$phpmailer_smtpuser = "info@vividwa.com.au";
$phpmailer_smtppassword = "Huaer2017yushaonianwa";
define("PHPMAILERPORT",80);
...
define('TEST', 0);
define('UPLOADIMAGES_DIR',"vividwa3/lists/uploadimages");
...
$pageroot = '/vividwa3/lists';
$adminpages = '/vividwa3/lists/admin';
